...
TRAINING_DATA <- read.csv(paste0(site, "_", DATA_TYPE,"_top_",top_n_amps,"_amps.csv"), row.names = 1) 
...
ggsave(paste0("training_data_EDA_distributions_",site,"_top_",top_n_amps,"_amps.png"), distributions, bg = "white", height = 8, width = 8, dpi = 300)
...
saveRDS(bootstrap_convergence, paste0("training_data_EDA_median_bootstrap_convergence_",site,"_top_",top_n_amps,"_amps.RDS"))
...
# Save the plot
ggsave(paste0("training_data_EDA_median_bootstrap_convergence_",site,"_top_",top_n_amps,"_amps.png"), plot = p, width = 12, height = 10, dpi = 300, bg = "white")
...
ggsave(paste0("training_data_EDA_boxplots_",site,"_top_",top_n_amps,"_amps.png"), var_boxplots, width = 12, height = 12, bg = "white")
...
ggsave(paste0("training_data_EDA_umap_",site,"_top_",top_n_amps,"_amps.png"), p, width = 10, height = 8, bg = "white")
...
ggsave(paste0("training_data_EDA_umap_feats_",site,"_top_",top_n_amps,"_amps.png"), final_plot, width = 18, height = 12, bg = "white")
...
#   ggsave(paste0("training_data_EDA_KMEANS_CLEAN_k_", k,"_Cabo_Delgado_top_50_amps_all_clones.png"), panels, width = 15, height = 7.5, bg = "white")  
#   
# }
...
write.csv(TRAINING_DATA, paste0("TRAINING_DATA_CLEAN_",site,"_top_",top_n_amps,"_amps.csv"), row.names = F)
